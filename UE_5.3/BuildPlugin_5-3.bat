...
%UNREAL_ENGINE_53%\Engine\Build\BatchFiles\RunUAT.bat BuildPlugin -plugin=%AYON_ROOT%\openpype\hosts\unreal\integration\UE_5.3\Ayon\Ayon.uplugin" -Package="%~dp0..\build\UE_5.3"
